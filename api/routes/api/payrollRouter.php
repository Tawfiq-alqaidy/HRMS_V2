...
Route::prefix('payroll')->group(function () {
    ...
    Route::post('/generate', [PayrollController::class, 'generateMonthlyPayroll'])->name('payroll.generate');
    Route::patch('/{id}', [PayrollController::class, 'update'])->name('payroll.update');
